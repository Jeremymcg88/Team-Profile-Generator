...
const memberCards = require("../Utils/createHTML");
    ...
    inquirer
        ...
        .then(( answers ) => {
            if (answers.members === "Build Team") {
                // This function creates the HTML with the constructor info when all the questions are answered and able to view when opening from index.html
